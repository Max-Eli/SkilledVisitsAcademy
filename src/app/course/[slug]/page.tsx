...
const COURSES: Record<string, {
  ...
  'aesthetic-injections-certification': {
    ...
    type: 'One-time · Lifetime access',
    badge: 'Core Course',
    tagline: 'The foundational aesthetic injection certification for licensed healthcare providers.',
    description: 'The complete foundational certification for aesthetic injectors. Facial anatomy, injection technique, product selection, complications, and scope of practice — the prerequisite for our advanced masterclasses.',
    longDescription: "SVA's Aesthetic Injections Certification is built for licensed clinicians moving into dermal fillers, neurotoxins, and PRF. You'll learn the facial anatomy that matters clinically, safe injection technique, product selection frameworks, and how to recognize and manage the complications every aesthetic provider needs to be prepared for. This is the prerequisite for our Dermal Filler, Botox, and PRF masterclasses.",
    duration: '10–12 hours',
    lessons: 12,
    students: 'New',
    level: 'Beginner to Intermediate',
    ...
    curriculum: [
      { section: 'Module 1–2: Foundations', lessons: ['Introduction to aesthetic injections & scope of practice', 'Facial anatomy for injectors — danger zones & key landmarks'] },
      { section: 'Module 3–4: Patient Consultation', lessons: ['Consultation, facial assessment & treatment planning', 'Contraindications & patient selection'] },
      { section: 'Module 5–6: Injection Technique', lessons: ['Needle vs cannula — technique comparison', 'Product selection fundamentals (HA fillers, neurotoxins, PRF)'] },
      { section: 'Module 7–8: Safety & Compliance', lessons: ['Aseptic technique & injection safety', 'Legal considerations & state scope of practice'] },
      { section: 'Module 9–10: Complication Management', lessons: ['Recognizing vascular occlusion & ischemia', 'Hyaluronidase protocol & emergency response'] },
      { section: 'Module 11–12: Documentation & Certification', lessons: ['Documentation, photography & consent forms', 'Course review & certification exam'] },
    ],
    faqs: [
      { q: 'What license types are eligible?', a: 'RNs, NPs, PAs, MDs, DOs, and Dentists under their state scope. License verification is required at enrollment.' },
      { q: 'How long do I have access?', a: 'Lifetime access. One purchase — no subscriptions, no renewals. All future updates to this course are included.' },
      { q: 'Do I need this before the aesthetic masterclasses?', a: 'Yes. Our Dermal Filler, Botox, and PRF masterclasses build on the foundational knowledge taught here. We strongly recommend completing this Core Course first.' },
      { q: 'Does this include hands-on training?', a: 'This program is didactic. Hands-on training is available through our partner live workshops — contact us for details.' },
    ],
    instructorNote: 'This course was developed for licensed clinicians who want to add aesthetic services to their practice with confidence. Safety and complication management are emphasized throughout.',
    relatedCourses: ['aesthetic-mastery-bundle', 'dermal-fillers', 'botox'],
  },
  'aesthetic-mastery-bundle': {
    ...
    type: 'One-time · Save $396',
    badge: 'Best Value',
    tagline: 'The complete aesthetic injections education — certification plus every masterclass.',
    description: 'The Aesthetic Core Certification plus all four Advanced Masterclasses — Dermal Fillers, Botox, PRF, and PRF EZGel. Save $396 versus buying separately.',
    longDescription: "The Complete Aesthetic Mastery Bundle is everything we teach for aesthetic injectors: the Core Certification plus all four Advanced Masterclasses. If you're building or scaling an aesthetic practice, this is the most efficient way to get fully trained across the procedures patients request most.",
    duration: '25–30 hours total',
    lessons: 52,
    students: 'New',
    level: 'Beginner to Advanced',
    ...
    curriculum: [
      { section: 'Aesthetic Injections Certification (Core)', lessons: ['All 12 Core modules — see Core Course for full curriculum'] },
      { section: 'Dermal Fillers Masterclass', lessons: ['HA filler product selection & rheology', 'Regional injection technique — lips, cheeks, jawline', 'Vascular occlusion recognition & hyaluronidase protocol'] },
      { section: 'Botox (Neurotoxin) Masterclass', lessons: ['Neurotoxin pharmacology & dosing', 'Upper-face injection patterns (glabella, forehead, crow\'s feet)', 'Advanced applications & troubleshooting asymmetry'] },
      { section: 'PRF Therapy Masterclass', lessons: ['PRF science & draw/spin protocols', 'Facial rejuvenation injection technique', 'Combination protocols with fillers & microneedling'] },
      { section: 'PRF EZGel Masterclass', lessons: ['EZGel preparation & longevity advantages', 'Volumizing applications & injection depth', 'Combination with traditional PRF'] },
    ],
    faqs: [
      { q: "What's included in this bundle?", a: 'The Aesthetic Injections Certification (Core) plus all four Advanced Masterclasses — a total value of $895.' },
      { q: 'Can I buy the masterclasses separately later?', a: 'Yes, but the bundle saves you $396. Each masterclass requires the Core Course as a prerequisite.' },
      { q: 'How long does this take to complete?', a: 'Approximately 25–30 hours of video content. Most providers complete the full bundle over 3–5 weeks.' },
    ],
    instructorNote: 'The bundle is built for providers launching or scaling an aesthetic practice. Getting certified across all five programs sets you apart in a competitive market.',
    relatedCourses: ['aesthetic-injections-certification', 'dermal-fillers', 'botox'],
  },
  'dermal-fillers': {
    key: 'dermal-fillers',
    ...
    tagline: 'Master HA filler product selection, regional injection technique, and complication management.',
    description: 'A complete clinical foundation in dermal filler injection — product selection, regional technique, and managing the complications every injector needs to be prepared for.',
    longDescription: "This masterclass goes deep into dermal fillers: how HA products differ, where each one performs best, and how to execute clean regional injections for lips, cheeks, and the jawline. You'll also learn to recognize and respond to vascular occlusion — the single most important skill set for any filler provider.",
    duration: '5–6 hours',
    lessons: 6,
    students: 'New',
    level: 'Intermediate (Aesthetic Core required)',
    includes: [
    ...
    curriculum: [
      { section: 'Module 1–2: Product Foundations', lessons: ['HA filler rheology, G prime & product families', 'Matching product to indication'] },
      { section: 'Module 3–4: Regional Technique', lessons: ['Lip injection: anatomy, technique & balance', 'Cheek & midface volumization'] },
      { section: 'Module 5–6: Safety & Complications', lessons: ['Needle vs cannula — decision framework', 'Vascular occlusion, ischemia & hyaluronidase protocol'] },
    ],
    faqs: [
      { q: 'Do I need the Aesthetic Core Course first?', a: 'Yes. This masterclass builds on foundational anatomy and injection technique. Purchase the Complete Aesthetic Bundle to get everything at once.' },
      { q: 'Does this cover hyaluronidase?', a: 'Yes. Full vascular occlusion recognition and hyaluronidase protocol is covered as a core safety module.' },
    ],
    instructorNote: 'Dermal fillers are the highest-volume aesthetic procedure — and the one where complications can be most serious. This course treats safety with the seriousness it deserves.',
    relatedCourses: ['aesthetic-injections-certification', 'aesthetic-mastery-bundle', 'botox'],
  },
  'botox': {
    key: 'botox',
    ...
    priceInt: 14900,
    type: 'One-time · Requires Aesthetic Core',
    tagline: 'Master neurotoxin dosing, injection patterns, and troubleshooting asymmetry.',
    description: 'A complete clinical foundation in neurotoxin injection — pharmacology, upper-face patterns, advanced applications, and how to troubleshoot real-world results.',
    longDescription: "This masterclass gives you the clinical foundation for safe, effective neurotoxin injection. You'll cover pharmacology and dosing across the major brands, upper-face injection patterns most patients request, and advanced applications including masseter and lip flip. We spend real time on troubleshooting — because asymmetry and uneven results are what separate competent injectors from great ones.",
    duration: '4–5 hours',
    lessons: 6,
    students: 'New',
    level: 'Intermediate (Aesthetic Core required)',
    includes: [
      ...
      'Glabella, forehead & crow\'s feet injection patterns',
      'Masseter & lower-face applications',
      'Lip flip & advanced technique',
      'Troubleshooting asymmetry & suboptimal results',
    ],
    curriculum: [
      { section: 'Module 1–2: Pharmacology & Dosing', lessons: ['Neurotoxin pharmacology & brand comparison', 'Dosing strategy by patient profile'] },
      { section: 'Module 3–4: Upper-Face Patterns', lessons: ['Glabella & forehead injection pattern', 'Crow\'s feet & periorbital considerations'] },
      { section: 'Module 5–6: Advanced & Troubleshooting', lessons: ['Masseter, lip flip & advanced applications', 'Asymmetry, ptosis & touch-up protocols'] },
    ],
    faqs: [
      { q: 'Do I need the Aesthetic Core Course first?', a: 'Yes. This masterclass builds on foundational anatomy and injection technique. Purchase the Complete Aesthetic Bundle to get everything at once.' },
      { q: 'Does this cover multiple neurotoxin brands?', a: 'Yes. Botox, Dysport, Xeomin, and Jeuveau are compared in detail including unit conversion and onset timing.' },
    ],
    instructorNote: 'Neurotoxin injection looks simple on the surface — but the difference between a good injector and a great one is in the troubleshooting. We spend real time there.',
    relatedCourses: ['aesthetic-injections-certification', 'aesthetic-mastery-bundle', 'dermal-fillers'],
  },
  'prf-therapy': {
    key: 'prf-therapy',
    ...
    priceInt: 14900,
    type: 'One-time · Requires Aesthetic Core',
    tagline: 'Master PRF draw, spin protocols, and facial rejuvenation injection technique.',
    description: 'A complete clinical foundation in platelet-rich fibrin — the science, draw and spin protocols, and injection technique for natural-looking facial rejuvenation.',
    longDescription: "PRF (platelet-rich fibrin) has become a flagship offering for aesthetic practices that emphasize natural-looking results. This masterclass covers the underlying science, the draw and spin protocols that actually produce clinical-grade PRF, and the injection technique for facial rejuvenation — including how to combine PRF with fillers and microneedling for compounding effects.",
    duration: '4–5 hours',
    lessons: 6,
    students: 'New',
    level: 'Intermediate (Aesthetic Core required)',
    ...
    curriculum: [
      { section: 'Module 1–2: PRF Science', lessons: ['What PRF is and how it works clinically', 'Comparing PRP vs PRF — when to use each'] },
      { section: 'Module 3–4: Draw & Spin', lessons: ['Blood draw technique & tube selection', 'Centrifuge protocols for clinical-grade PRF'] },
      { section: 'Module 5–6: Injection Technique', lessons: ['Facial rejuvenation injection — regional approach', 'Combination protocols with microneedling & fillers'] },
    ],
    faqs: [
      { q: 'Do I need the Aesthetic Core Course first?', a: 'Yes. This masterclass builds on foundational anatomy and injection technique. Purchase the Complete Aesthetic Bundle to get everything at once.' },
      { q: 'Do I need special equipment?', a: 'A PRF-compatible centrifuge and draw kit. The course covers the equipment choices that produce clinical-grade results.' },
    ],
    instructorNote: 'PRF is one of the most rewarding procedures to offer — natural results, high patient satisfaction, and excellent margins. The technique is what makes or breaks it.',
    relatedCourses: ['aesthetic-injections-certification', 'aesthetic-mastery-bundle', 'prf-ezgel'],
  },
  'prf-ezgel': {
    key: 'prf-ezgel',
    ...
    priceInt: 14900,
    type: 'One-time · Requires Aesthetic Core',
    tagline: 'Master EZGel preparation, volumizing applications, and combination protocols.',
    description: 'A complete clinical foundation in PRF EZGel — the preparation protocol, volumizing applications, and how to combine it with traditional PRF for compounding results.',
    longDescription: "PRF EZGel is the next generation of platelet-rich fibrin — a longer-lasting, volumizing variant that extends the utility of PRF into filler-adjacent indications. This masterclass covers the preparation protocol, where EZGel shines versus traditional PRF, and the injection depth and technique that produce visible volume without the risks of HA fillers in certain anatomical regions.",
    duration: '4–5 hours',
    lessons: 6,
    students: 'New',
    level: 'Intermediate (Aesthetic Core required)',
    ...
    curriculum: [
      { section: 'Module 1–2: EZGel Foundations', lessons: ['How EZGel differs from traditional PRF', 'Thermal activation & clinical-grade preparation'] },
      { section: 'Module 3–4: Volumizing Applications', lessons: ['Regional volumizing technique', 'Injection depth considerations'] },
      { section: 'Module 5–6: Combinations & Longevity', lessons: ['Combining EZGel with traditional PRF', 'Result longevity, retreatment & patient expectations'] },
    ],
    faqs: [
      { q: 'Do I need the Aesthetic Core Course first?', a: 'Yes. This masterclass builds on foundational anatomy and injection technique. Purchase the Complete Aesthetic Bundle to get everything at once.' },
      { q: 'How is EZGel different from standard PRF?', a: 'EZGel undergoes thermal activation to produce a longer-lasting gel with volumizing properties — extending PRF into filler-adjacent indications.' },
    ],
    instructorNote: 'EZGel is where PRF and fillers converge. For providers who want the safety profile of autologous products with visible volumizing effect, this is a must-have technique.',
    relatedCourses: ['aesthetic-injections-certification', 'aesthetic-mastery-bundle', 'prf-therapy'],
  },
}
...
const RELATED_TITLES: Record<string, { title: string; price: string; subtitle: string }> = {
  ...
  'complete-mastery-bundle': { title: 'Complete IV Mastery Bundle', price: '$499', subtitle: 'Best Value — Save $396' },
  ...
  'aesthetic-injections-certification': { title: 'Aesthetic Injections Certification', price: '$299', subtitle: 'Core Course' },
  'aesthetic-mastery-bundle': { title: 'Complete Aesthetic Mastery Bundle', price: '$499', subtitle: 'Best Value — Save $396' },
  'dermal-fillers': { title: 'Dermal Fillers Masterclass', price: '$149', subtitle: 'Masterclass' },
  'botox': { title: 'Botox (Neurotoxin) Masterclass', price: '$149', subtitle: 'Masterclass' },
  'prf-therapy': { title: 'PRF Therapy Masterclass', price: '$149', subtitle: 'Masterclass' },
  'prf-ezgel': { title: 'PRF EZGel Masterclass', price: '$149', subtitle: 'Masterclass' },
}
